...
void Collision(Ball& ball, Paddle& stick1,Paddle& stick0,Sound& paddle,Sound& score, int& puan0, int& puan1) // ball out of range puan++
{
	...
	{
		//e�er ball: down-right ise ve stick up ise speed'i 2 ile �arp  SPEED UP....
		if (ball.dir == 2 && stick1.dir == 0)
		{
			ball.speed.x *= 1.4f;
			ball.speed.y *= 1.4f;
		}
		//e�er ball: up-right ise ve stick down ise speed'i 2 ile �arp  SPEED UP....
	...
	{
		//e�er ball: down-left ise ve stick up ise speed'i 2 ile �arp  SPEED UP....
		if (ball.dir == 3 && stick0.dir == 0)
		{
			ball.speed.x *= 1.4f;
			ball.speed.y *= 1.4f;
		}
		//e�er ball: up-left ise ve stick down ise speed'i 2 ile �arp  SPEED UP....
